...
const legalContent = {
  terms: {
    ...
    content: (
      <div className="space-y-4">
        <p>
          Welcome to IRIS. By accessing or using
          https://assets.neuralarc.ai (the "Platform"), you agree to be bound
        ...
        <div>
          ...
          <p>
            ...
            are owned by IRIS or its licensors. You may not copy,
  ...
  privacy: {
    ...
    content: (
      <div className="space-y-4">
        <p>
          IRIS ("Platform," "we," "us," or "our") is committed to
  ...
  disclaimer: {
    ...
    content: (
      <div className="space-y-4">
        ...
        <p>
          The tools and content available at https://assets.neuralarc.ai are
    ...
    content: (
      <div className="space-y-4">
        ...
        <p>
          ...
          technologies hosted on https://assets.neuralarc.ai are designed to
...
export default function RootLayout({
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <body className="font-sans antialiased bg-background text-foreground min-h-screen flex flex-col" style={{ fontFamily: 'Fustat, sans-serif' }}>
        {children}
        <Footer />
        <Toaster />
      </body>
